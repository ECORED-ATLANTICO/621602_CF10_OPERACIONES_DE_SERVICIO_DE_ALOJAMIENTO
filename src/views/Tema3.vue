  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5.mb-5
    ...
    .row.mb-5.justify-content-center.align-items-center
      ...
      .col-lg-9
        ...
        p.mb-2(data-aos="fade-right") Durante el proceso de reservación y el check-in de huéspedes internacionales, es importante recopilar, verificar y proporcionar información relevante de manera clara y precisa. Una comunicación efectiva contribuye a una experiencia positiva y favorece la adecuada prestación de los servicios hoteleros.
